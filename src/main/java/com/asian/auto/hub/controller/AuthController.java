...
import com.asian.auto.hub.dto.LoginRequest;
import com.asian.auto.hub.dto.RefreshTokenRequest;
import com.asian.auto.hub.dto.TokenResponse;
...
import com.asian.auto.hub.repository.RefreshTokenRepository;
import com.asian.auto.hub.repository.UserRepository;
import com.asian.auto.hub.service.AuthService;
import com.asian.auto.hub.serviceimpl.CookieService;
...
//        TokenResponse tokenResponse = TokenResponse.of(accessToken, refreshToken, jwtService.getAccessTtlSeconds(), mapper.map(user, UserDto.class));
	...
	public ResponseEntity<TokenResponse> refreshToken(@RequestBody(required = false) RefreshTokenRequest body,
		...
		if (!storedRefreshToken.getUser().getId().toString().equals(userId)) {
...
////            1. prefer reading refresh token from cookie
	...
	public ResponseEntity<UserRolesDto> registerUser(@RequestBody UserDto userDto) {
